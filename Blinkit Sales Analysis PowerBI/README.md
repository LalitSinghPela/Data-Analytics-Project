...
#Tools & Technologies
Power BI Data Visualization KPI Analysis

#What I Did
Imported the dataset into Power BI Created important KPIs like total sales, average sales, and ratings Built an interactive dashboard using filters and slicers Analyzed sales patterns across outlet types, sizes, and locations

#Key Insights
Total sales reached $1.20M across 8,523 items Supermarket Type 1 outlets generated the highest revenue ($0.79M) Tier 3 locations showed the best performance with $472.13K in sales Outlet establishments peaked in 2018 Medium-sized outlets contributed the most (42.27% of total sales)
